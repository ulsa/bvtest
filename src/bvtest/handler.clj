(ns bvtest.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [bvtest.routes.home :refer [home-routes]]
            [bvtest.middleware :as middleware]
            [bvtest.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "bvtest is shutting down...")
  (stop-nrepl)
